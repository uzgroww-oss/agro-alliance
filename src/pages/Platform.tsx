      ...
      <div className="mx-auto max-w-[1320px] px-5 pt-7 lg:px-8">
        ...
        <div className="grid gap-8 pt-8 pb-10 xl:grid-cols-[1fr_0.7fr_320px]">
          <div className="flex flex-col justify-center">
            ...
            <Reveal delay={160}>
              <div className="mt-7 flex flex-wrap gap-4">
                <Link to="/kirish" className="inline-flex items-center gap-2 rounded-xl bg-green px-6 py-3.5 font-bold text-white shadow-lg shadow-green/30 transition-transform hover:scale-105">
          ...
          <div className="relative hidden items-center justify-center xl:flex">
            <Mascot alt="Agro Alliance" eager className="animate-float relative w-full max-w-[360px] object-contain drop-shadow-2xl" />
          </div>
          <Reveal delay={160}>
          ...
          <Reveal key={c.t} delay={(i % 3) * 80}>
            <div className="group flex h-full flex-col rounded-2xl border border-green/10 bg-white p-7 shadow-[0_4px_24px_rgba(91,180,32,0.06)] transition-all hover:-translate-y-1 hover:border-green/30 hover:shadow-[0_16px_40px_rgba(91,180,32,0.14)]">
              <span className="grid h-14 w-14 place-items-center rounded-2xl bg-soft text-green transition-colors group-hover:bg-green group-hover:text-white">
                <Icon d={iconMap[c.icon] || I.star} className="h-7 w-7" />
              </span>
